...
public class GenInterfaceGenerator : IIncrementalGenerator
{
    public static readonly DiagnosticDescriptor ClassIsNotPartial = new(
        ...
        category: "GenerateInterfaceAttributeGenerator",
    ...
    )
    {
        ...
        if (compilation.GetTypeByMetadataName("TheUtils.GenerateInterfaceAttribute") == null)
    ...
    static ClassDeclarationSyntax GetSemanticTargetForGeneration(GeneratorSyntaxContext context)
    {
        ...
        foreach (var attributeSyntax in attributeListSyntax.Attributes)
        {
            ...
            if (fullName is "TheUtils.GenerateInterfaceAttribute")
